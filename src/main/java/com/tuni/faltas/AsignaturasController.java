...
public class AsignaturasController implements Initializable {
	...
	private void comboBoxCurso() {
		...
		if (asignaturas != null) {
			...
			listAsignatura = comboBoxCursos.getSelectionModel().getSelectedItem().getAsignaturas();
			comboBoxAsignaturas.setItems(comboBoxCursos.getSelectionModel().getSelectedItem().getAsignaturas());
		}
	}
